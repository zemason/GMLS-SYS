...
<div class="space-y-4">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <h3 class="text-lg font-semibold text-gray-800">Tambah Data Lokasi</h3>
        </div>
        
        <!-- Card Body -->
        <div class="p-6">
            <form action="{{route('admin.lokasi.store')}}" method="POST" enctype="multipart/form-data" class="space-y-4">
                @csrf
                ...
                <div class="space-y-2">
                    ...
                    >
                        @foreach ($relawans as $relawan)
                            <option value="{{$relawan->id}}" @if (old('relawan_id') == $relawan->id) selected @endif
