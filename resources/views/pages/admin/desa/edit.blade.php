...
<div class="space-y-4">
    <!-- Back Button -->
    <a href="{{route('admin.desa.index')}}" class="inline-flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white rounded-md transition duration-200">
    ...
    <div class="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <h3 class="text-lg font-semibold text-gray-800">Edit Data Desa</h3>
        </div>
            ...
            <form action="{{route('admin.desa.update', $desa->id)}}" method="POST" class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="nama_desa" name="nama_desa" 
                           ...
                           class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('nama_desa') border-red-500 @enderror"
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="alamat_desa" name="alamat_desa" 
                           value="{{ old('alamat_desa', $desa->alamat_desa) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('alamat_desa') border-red-500 @enderror"
                ...
                <div class="flex justify-end">
                    <button type="submit" class="px-6 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md shadow-sm transition duration-200 flex items-center">
