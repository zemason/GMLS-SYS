...
@section('content')
<div class="space-y-4">
    <a href="{{route('admin.relawan.index')}}" class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-md mb-4 inline-block">
        Kembali
    </a>

    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200">
            <h6 class="text-lg font-semibold text-gray-800">Tambah Data</h6>
        </div>
        <div class="p-6">
            <form action="{{route('admin.relawan.store')}}" method="POST" enctype="multipart/form-data" class="space-y-4">
                @csrf
                <div class="space-y-2">
                ...
                <div class="space-y-2">
                    ...
                    <input type="email" class="w-full px-3 py-2 border rounded-md @error('email') border-red-500 @enderror" 
